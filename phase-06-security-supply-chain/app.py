#!/usr/bin/env python3
"""
Phase 6 Flask App - Secure version with observability.
Same as Phase 5, demonstrating security best practices.
"""
...
logger = logging.getLogger('phase6-web')
...
def index():
    return jsonify({
        'service': 'phase6-flask-secure',
        'phase': 6,
        'description': 'Security and supply chain demo',
        'security': {
            'user': os.getenv('USER', 'unknown'),
            'read_only': os.path.exists('/.dockerenv') and not os.access('/', os.W_OK),
        },
        'endpoints': {
